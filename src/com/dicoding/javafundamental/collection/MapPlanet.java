...
public class MapPlanet {
    public static void main(String[] args) {
        ...
        Map<String, Planet> planets = new HashMap(); // menggunakan salah satu implementasi dari Map yaitu HashMap
        ...
        for (Planet planet : planets.values()) { // looping value dari Map menggunakan for-each loop
